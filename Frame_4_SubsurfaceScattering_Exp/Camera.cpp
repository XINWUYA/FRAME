...
CCamera::CCamera(glm::dvec3 vCameraPos, glm::dvec3 vCameraFront, glm::dvec3 vUpVector) :m_CameraPos(vCameraPos), m_CameraFront(vCameraFront), m_UpVector(vUpVector)
{
