...
void CShowCubeMapPass::initV()
{
	...
	m_PrefilterEnvCubeTexture = ElayGraphics::ResourceManager::getSharedDataByName<int>("PrefilterEnvMap");
}
...
void CShowCubeMapPass::updateV()
{
	...
	glBindTexture(GL_TEXTURE_CUBE_MAP, m_PrefilterEnvCubeTexture);
