...
void CShowCubeMapPass::initV()
{
	...
	m_IrradianceCubeTexture = ElayGraphics::ResourceManager::getSharedDataByName<int>("IrradianceCubeTexture");
}
...
void CShowCubeMapPass::updateV()
{
	...
	glBindTexture(GL_TEXTURE_CUBE_MAP, m_IrradianceCubeTexture);
